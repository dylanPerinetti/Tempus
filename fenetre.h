...
void InitialiseHexagone(SDL_Renderer* _rendu, SDL_Rect *_Hexagone,Tuile _tuile);		//Crée une ligne Hexagone renvois le

void DecallageHexagoneY(SDL_Rect *Hex, unsigned char d);								//Decalle les coordonées x et y au début de la génération d'une nouvelle rangée d'hexagone
